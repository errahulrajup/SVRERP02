...
const NAV = [
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
        <path d="M8 3H2v13l6.29 6.29c.94.94 2.48.94 3.42 0l4.29-4.29c.94-.94.94-2.48 0-3.42L8 3z"/>
        <path d="M6 18L4 6"/><circle cx="4.5" cy="9.5" r="0.5" fill="currentColor"/>
      </svg>
    ),
  },
  {
      ...
      module={{
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth="1.8" strokeLinecap="round">
            <path d="M8 3H2v13l6.29 6.29c.94.94 2.48.94 3.42 0l4.29-4.29c.94-.94.94-2.48 0-3.42L8 3z"/>
            <path d="M6 18L4 6"/><circle cx="4.5" cy="9.5" r="0.5" fill="#D4A843"/>
          </svg>
        ),
