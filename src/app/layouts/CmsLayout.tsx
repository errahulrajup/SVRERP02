...
const NAV = [
  {
    ...
    minRole: 'EDITOR',
    items: [
      { icon: Icons.products,     label: 'Products',       path: '/cms/products' },
      { icon: Icons.categories,   label: 'Categories',     path: '/cms/categories' },
      { icon: Icons.blog,         label: 'Blog',            path: '/cms/blog' },
      { icon: Icons.homepage,     label: 'Homepage',        path: '/cms/homepage' },
      { icon: Icons.about,        label: 'About Page',      path: '/cms/about' },
      { icon: Icons.testimonials, label: 'Testimonials',    path: '/cms/testimonials' },
      { icon: Icons.media,        label: 'Media Library',   path: '/cms/media' },
    ],
  },
  {
    section: 'Operations',
    minRole: 'MANAGER',
    items: [
      { icon: Icons.inquiries,    label: 'Inquiries',       path: '/cms/inquiries', badge: true },
      { icon: Icons.seo,          label: 'SEO Manager',     path: '/cms/seo' },
      { icon: Icons.analytics,    label: 'Analytics',       path: '/cms/analytics' },
      { icon: Icons.settings,     label: 'Site & Social',   path: '/admin/settings' },
    ],
  },
 ] as const;
