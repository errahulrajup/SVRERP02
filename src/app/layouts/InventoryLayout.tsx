  ...
  return (
    <div className="inv-app" style={{ display: 'flex', minHeight: '100vh', background: '#0C1510', color: '#F0EDE6', fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif" }}>
      ...
      <aside className={`inv-sidebar${open ? ' open' : ''}`}>
        <div style={{ padding: '20px 16px 14px', borderBottom: '1px solid rgba(123,169,123,0.12)', marginBottom: 8, cursor: 'pointer' }} onClick={() => navigate('/inventory/store')}>
          ...
          <div style={{ fontSize: 9, color: '#A07828', letterSpacing: '2px', textTransform: 'uppercase', marginTop: 3, fontWeight: 600 }}>Material Control</div>
        </div>
        ...
        <div style={{ padding: '12px', borderTop: '1px solid rgba(123,169,123,0.12)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#0C1510', padding: '10px 12px', borderRadius: 8, border: '1px solid rgba(123,169,123,0.12)' }}>
            <div style={{ flex: 1, overflow: 'hidden' }}>
              <div style={{ fontSize: 12, fontWeight: 600, color: '#F0EDE6', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }}>{role || 'Staff'}</div>
              <div style={{ fontSize: 10, color: '#556355' }}>Store Module</div>
            </div>
