...
const NAV = [
  {
    path: '/fsms', exact: true, label: 'HACCP Logs',
  ...
  {
    path: '/fsms/prp', label: 'PRP Logs',
    icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>),
  },
  {
    path: '/fsms/allergen', label: 'Allergen Control',
  ...
  {
    path: '/fsms/recall', label: 'Recalls',
    icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.51"/></svg>),
  },
  {
    path: '/fsms/sop', label: 'SOP Register',
  ...
  {
    path: '/fsms/training', label: 'Training Matrix',
  ...
  {
    path: '/fsms/live-ccp', label: 'Live CCP Monitor',
  ...
  {
    path: '/fsms/cto', label: 'CTO Dashboard',
...
export function FsmsLayout() {
  return (
    <AppShell
      module={{
        icon: (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.8" strokeLinecap="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>),
        label: 'FSMS',
        sublabel: 'Food Safety Management System',
      }}
      nav={NAV}
    >
      <Outlet />
