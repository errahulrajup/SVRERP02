...
const NAV = [
  {
    path: '/dms', exact: true, label: 'Dashboard',
    icon: (
  ...
  {
    path: '/dms/new', label: 'New Document',
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    path: '/dms/records', label: 'All Documents',
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    path: '/dms/templates', label: 'Templates',
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    path: '/dms/verify', label: 'Verify Document',
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    path: '/dms/settings', label: 'Settings',
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <BosModuleLayout
      module={{
        ...
        label: 'DMS Pro',
        sublabel: 'Document Management System',
      }}
      nav={NAV}
    >
      <Outlet />
